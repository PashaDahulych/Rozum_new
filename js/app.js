(() => {
    ...
    da.init();
    const userAuthorized = document.querySelector(".sub-title");
    const infoUser = document.querySelector(".sub-title__tultip");
    function showInfoUser() {
        infoUser.classList.add("_open-user");
    }
    function hideInfoUser() {
        infoUser.classList.remove("_open-user");
    }
    userAuthorized.addEventListener("click", (function(event) {
        if (event.target.closest(".sub-title")) if (infoUser.classList.contains("_open-user")) hideInfoUser(); else showInfoUser(); else hideInfoUser();
    }));
    document.addEventListener("click", (function(event) {
        if (!event.target.closest(".sub-title") && !event.target.closest(".info-user")) hideInfoUser();
    }));
    window["FLS"] = true;
    isWebp();
    spollers();
